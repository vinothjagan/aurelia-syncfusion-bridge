export class BasicUse {
  ...
  this.quantitativeScaleSettings= {
			...
			this.captionSettings={ textAngle: 0,
			...
			this.quantitativeScaleSettings1= {
                location: { x: 110, y: 10 },
                minimum: -10,
                maximum: 10,
                interval: 2,
			...
			this.captionSettings1= { textAngle: 0,
			...
			this.quantitativeScaleSettings2= {
                location: { x: 105, y: 10 },
                minimum: -10,
                maximum: 10,
                interval: 2,
			...
			this.captionSettings2= { textAngle: 0,
			...
			this.quantitativeScaleSettings3= {
                location: { x: 105, y: 10 },
                minimum: 0,
                maximum: 10,
                interval: 1,
			...
			this.captionSettings3= { textAngle: 0,
