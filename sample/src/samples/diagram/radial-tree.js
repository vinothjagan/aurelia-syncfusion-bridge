export class RadialTree {
        ...
        let data = [
          {
              ...
              'ImageUrl': 'src/samples/diagram/images/radial/Clayton.png', 'IsExpand': 'true', 'RatingColor': '#C34444'
          },
          {
          ...
          },
          {
              ...
              'ImageUrl': 'src/samples/diagram/images/radial/Paul.png', 'IsExpand': 'true',
              'RatingColor': '#68C2DE', 'ReportingPerson': 'parent'
          },
          {
              'Id': 5, 'Name': 'Anto Moreno', 'Designation': 'Project Lead',
              'ImageUrl': 'src/samples/diagram/images/radial/image53.png', 'IsExpand': 'false',
              'RatingColor': '#93B85A', 'ReportingPerson': 1
          },
          {
              'Id': 6, 'Name': 'Elizabeth Roel', 'Designation': 'Project Lead',
              'ImageUrl': 'src/samples/diagram/images/radial/Maria.png', 'IsExpand': 'false',
              'RatingColor': '#93B85A', 'ReportingPerson': 1
          },
          {
              'Id': 7, 'Name': 'Aria Cruz', 'Designation': 'Project Lead',
              'ImageUrl': 'src/samples/diagram/images/radial/Jenny.png', 'IsExpand': 'false',
              'RatingColor': '#93B85A', 'ReportingPerson': 1
          },
          {
          ...
          },
          {
              ...
              'ImageUrl': 'src/samples/diagram/images/radial/John.png', 'IsExpand': 'None',
              'RatingColor': '#EBB92E', 'ReportingPerson': 90
          },
          {
              'Id': 17, 'Name': 'Matti Kenna', 'Designation': 'Project Lead',
              'ImageUrl': 'src/samples/diagram/images/radial/Jenny.png', 'IsExpand': 'None',
          ...
          },
          {
              ...
              'ImageUrl': 'src/samples/diagram/images/radial/Clayton.png', 'IsExpand': 'true',
              'RatingColor': '#93B85A', 'ReportingPerson': 4
          },
          {
              'Id': 20, 'Name': 'Thomas Hardy', 'Designation': 'Senior S/w Engg',
              'ImageUrl': 'src/samples/diagram/images/radial/image57.png', 'IsExpand': 'false',
              'RatingColor': '#68C2DE', 'ReportingPerson': 12
          },
          {
              'Id': 21, 'Name': 'Mart�n Kloss', 'Designation': 'Senior S/w Engg',
              'ImageUrl': 'src/samples/diagram/images/radial/Robin.png', 'IsExpand': 'false',
              'RatingColor': '#93B85A', 'ReportingPerson': 5
          },
          {
              'Id': 22, 'Name': 'Maria Larsson', 'Designation': 'Senior S/w Engg',
              'ImageUrl': 'src/samples/diagram/images/radial/image51.png', 'IsExpand': 'false',
              'RatingColor': '#EBB92E', 'ReportingPerson': 6
          },
          {
              'Id': 23, 'Name': 'Diego Roel', 'Designation': 'Senior S/w Engg',
              'ImageUrl': 'src/samples/diagram/images/radial/image55.png', 'IsExpand': 'false',
          ...
          },
          {
              ...
              'ImageUrl': 'src/samples/diagram/images/radial/image56.png', 'IsExpand': 'None',
              'RatingColor': '#D46E89', 'ReportingPerson': 8
          },
          {
          ...
          },
          {
              ...
              'ImageUrl': 'src/samples/diagram/images/radial/image57.png', 'IsExpand': 'None',
          ...
          },
          {
              ...
              'ImageUrl': 'src/samples/diagram/images/radial/Thomas.png', 'IsExpand': 'None',
              'RatingColor': '#D46E89', 'ReportingPerson': 16
          },
          {
              'Id': 33, 'Name': 'Pirkko King', 'Designation': 'Senior S/w Engg',
              'ImageUrl': 'src/samples/diagram/images/radial/Robin.png', 'IsExpand': 'None',
          ...
          },
          {
              ...
              'ImageUrl': 'src/samples/diagram/images/radial/Clayton.png', 'IsExpand': 'false',
          ...
          {
              'Id': 47, 'Name': 'Jean Fresni�re', 'Designation': 'S/w Engg',
              'ImageUrl': 'src/samples/diagram/images/radial/Robin.png', 'IsExpand': 'false',
          ...
          {
              'Id': 53, 'Name': 'L�cia Carvalho', 'Designation': 'S/w Engg',
              'ImageUrl': 'src/samples/diagram/images/radial/Thomas.png', 'IsExpand': 'None',
              'RatingColor': '#93B85A', 'ReportingPerson': 30
          },
          {
              'Id': 54, 'Name': 'Hanna Moos', 'Designation': 'Project Trainee',
              'ImageUrl': 'src/samples/diagram/images/radial/image57.png', 'IsExpand': 'true',
          ...
          {
              'Id': 59, 'Name': 'Martine Ranc�', 'Designation': 'Project Trainee',
              'ImageUrl': 'src/samples/diagram/images/radial/image53.png', 'IsExpand': 'None',
          ...
          },
          {
              ...
              'ImageUrl': 'src/samples/diagram/images/radial/John.png', 'IsExpand': 'true',
          ...
          },
          {
              ...
              'ImageUrl': 'src/samples/diagram/images/radial/image51.png', 'IsExpand': 'true',
          ...
          {
              'Id': 81, 'Name': 'Rita M�ller', 'Designation': 'Project Trainee',
              'ImageUrl': 'src/samples/diagram/images/radial/Paul.png', 'IsExpand': 'None',
          ...
          },
          {
              ...
              'ImageUrl': 'src/samples/diagram/images/radial/eric.png', 'IsExpand': 'true',
    ...
    create(args) {
        let context = this;
        setTimeout(function () {
            let diagram = context.diagram.widget;
