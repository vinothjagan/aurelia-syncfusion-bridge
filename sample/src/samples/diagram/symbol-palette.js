export class SymbolPalette {
    ...
    changenumeric(args) {
        let symbolpalette =this.symbolpalette.widget;
    ...
    palettechange(args) {
        ...
        if (args && args.detail && args.detail.selectedValue) {
            this.symbolpalette.widget.setModel({ selectedPaletteName: args.detail.selectedValue });
        }
        window.preventChange = true;
        this.itemtext.widget.setModel({ checked: symbolpalette.model.showPaletteItemText ? 'checked' : '' });
        constraints = symbolpalette.activePalette.constraints & ej.datavisualization.Diagram.PaletteConstraints.HeaderVisibility;
        this.headervisibility.widget.setModel({ checked: constraints ? 'checked' : '' });
        constraints = symbolpalette.activePalette.constraints & ej.datavisualization.Diagram.PaletteConstraints.Visible;
        this.visiblepalette.widget.setModel({ checked: constraints ? 'checked' : '' });
        constraints = symbolpalette.activePalette.constraints & ej.datavisualization.Diagram.PaletteConstraints.Expandable;
        this.headerinteraction.widget.setModel({ checked: constraints ? 'checked' : '' });
