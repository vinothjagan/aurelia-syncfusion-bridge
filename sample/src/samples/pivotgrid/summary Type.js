export class BasicUse {
    constructor(){
      ...
      values: [
        ...
        this.target = 'Amount';
        this.target1 = 'Quantity';
        this.Amount = 'Average';
        this.Quantity = 'Sum';
    }
    onChange(args){
        var pivotGrid = $('.e-pivotgrid').data("ejPivotGrid");
        $.grep(pivotGrid.model.dataSource.values, function (item) { return item.fieldName == args.detail.model.targetID; })[0]["summaryType"] = args.detail.text.toLowerCase(); 
