export class BasicUse {
  constructor() {
    this.FruitsList = [
					...
					{ xName: "Phosphorus", yName: 20, yName1:26 },
					{ xName: "Sodium", yName: 8, yName1:7}, 
					{ xName: "Magnesium", yName: 9, yName1: 32},
					{ xName: "Manganese", yName: 8.5, yName1:9.6},
					{ xName: "Iron", yName: 6.3, yName1:8.1 }
					]; 
