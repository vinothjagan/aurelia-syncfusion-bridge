System.register(['../common/common', 'ej.spreadsheet.min'], function (_export) {
  'use strict';

  var inject, WidgetBase, constants, generateBindables, inlineView, customElement, children, ejSpreadsheet;
  ...
  return {
    ...
    execute: function () {
      ejSpreadsheet = (function (_WidgetBase) {
