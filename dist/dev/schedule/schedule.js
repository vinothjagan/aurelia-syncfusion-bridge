System.register(['../common/common', 'ej.schedule.min'], function (_export) {
  'use strict';

  var inject, WidgetBase, constants, generateBindables, inlineView, customElement, children, ejSchedule;
  ...
  return {
    ...
    }, function (_ejScheduleMin) {}],
    execute: function () {
      ejSchedule = (function (_WidgetBase) {
        ...
        _createDecoratedClass(ejSchedule, [{
          key: 'resources',
          decorators: [children(constants.elementPrefix + 'schedule-resource')],
          initializer: null,
          enumerable: true
        ...
        ejSchedule = inject(Element)(ejSchedule) || ejSchedule;
        ...
        ejSchedule = inlineView('<template><content></content></template>')(ejSchedule) || ejSchedule;
        ejSchedule = customElement(constants.elementPrefix + 'schedule')(ejSchedule) || ejSchedule;
        return ejSchedule;
      })(WidgetBase);
