System.register(['../common/common', 'ej.rotator.min'], function (_export) {
    ...
    var customElement, inlineView, inject, WidgetBase, constants, generateBindables, ejRotator;
    ...
    return {
        ...
        execute: function () {
            ejRotator = (function (_WidgetBase) {
                ...
                ejRotator = inlineView('<template><content></content></template>')(ejRotator) || ejRotator;
                ejRotator = customElement(constants.elementPrefix + 'rotator')(ejRotator) || ejRotator;
                return ejRotator;
            })(WidgetBase);
