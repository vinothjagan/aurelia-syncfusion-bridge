System.register(['../common/common', 'ej.treegrid.min'], function (_export) {
  'use strict';

  var inject, WidgetBase, constants, generateBindables, inlineView, customElement, children, TemplatingEngine, TemplateProcessor, ejTreeGrid;
  ...
  return {
    ...
    execute: function () {
      ejTreeGrid = (function (_WidgetBase) {
