...
System.register(['../common/common', 'ej.waitingpopup.min'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      _export('ejWaitingPopup', ejWaitingPopup = (_dec = customAttribute(constants.attributePrefix + 'waiting-popup'), _dec2 = generateBindables('ejWaitingPopup', ['cssClass', 'showImage', 'showOnInit', 'template', 'text']), _dec3 = inject(Element), _dec(_class = _dec2(_class = _dec3(_class = function (_WidgetBase) {
