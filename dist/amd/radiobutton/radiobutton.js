define(['exports', '../common/common', 'ej.radiobutton.min'], function (exports, _commonCommon, _ejRadiobuttonMin) {
    ...
    var ejRadioButton = (function (_WidgetBase) {
        ...
        ejRadioButton = _commonCommon.generateBindables('ejRadioButton', ['checked', 'cssClass', 'enabled', 'enablePersistence', 'enableRTL', 'htmlAttributes', 'id', 'idPrefix', 'name', 'size', 'text', 'validationMessage', 'validationRules', 'value'])(ejRadioButton) || ejRadioButton;
