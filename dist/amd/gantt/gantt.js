define(['exports', '../common/common', 'ej.gantt.min'], function (exports, _commonCommon, _ejGanttMin) {
  'use strict';
  ...
  var ejGantt = (function (_WidgetBase) {
    ...
    ejGantt = _commonCommon.inlineView('' + _commonCommon.constants.aureliaTemplateString)(ejGantt) || ejGantt;
