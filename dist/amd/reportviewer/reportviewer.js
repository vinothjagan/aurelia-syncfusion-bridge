define(['exports', '../common/widget-base', '../common/constants', '../common/decorators', '../common/common', 'ej.reportviewer.min'], function (exports, _widgetBase, _constants, _decorators, _common) {
  'use strict';
