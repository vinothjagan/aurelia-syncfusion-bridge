...
var ejColorPicker = exports.ejColorPicker = (_dec34 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'color-picker'), _dec35 = generateBindables('ejColorPicker', ['buttonText', 'buttonMode', 'columns', 'cssClass', 'custom', 'displayInline', 'enabled', 'enableOpacity', 'htmlAttributes', 'locale', 'modelType', 'opacityValue', 'palette', 'presetType', 'showApplyCancel', 'showClearButton', 'showPreview', 'showRecentColors', 'showSwitcher', 'showTooltip', 'toolIcon', 'tooltipText', 'value'], ['value', 'opacityValue']), _dec36 = (0, _aureliaDependencyInjection.inject)(Element), _dec34(_class15 = _dec35(_class15 = _dec36(_class15 = function (_WidgetBase8) {
  ...
  WidgetBase.prototype.createWidget = function createWidget(option) {
    ...
    if (this.isEditor) {
      this.widget.model._change = function (evt) {
        if ('eValue' in _this12) {
          _this12[_this12.util.getBindablePropertyName('value')] = evt.value;
        }
      };
    }
  };
      ...
      this.arrayObserver.forEach(function (arrayProp) {
        if (_this14[arrayProp] instanceof Array) {
          ...
          if (typeof modelValue === 'function') {
            ...
            _this14.widget.option(prop, newVal);
          } else {
            _this14.widget.option(prop, modelValue);
          }
        }
      });
    }
...
var ejDateTimePicker = exports.ejDateTimePicker = (_dec59 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'date-time-picker'), _dec60 = generateBindables('ejDateTimePicker', ['allowEdit', 'buttonText', 'cssClass', 'dateTimeFormat', 'dayHeaderFormat', 'depthLevel', 'enableAnimation', 'enabled', 'enablePersistence', 'enableRTL', 'enableStrictMode', 'headerFormat', 'height', 'htmlAttributes', 'interval', 'locale', 'maxDateTime', 'minDateTime', 'popupPosition', 'readOnly', 'showOtherMonths', 'showPopupButton', 'showRoundedCorner', 'startDay', 'startLevel', 'stepMonths', 'timeDisplayFormat', 'timeDrillDown', 'timePopupWidth', 'validationMessage', 'validationRules', 'value', 'watermarkText', 'width'], ['value'], { 'enableRTL': 'enableRtl' }), _dec61 = (0, _aureliaDependencyInjection.inject)(Element), _dec59(_class26 = _dec60(_class26 = _dec61(_class26 = function (_WidgetBase14) {
...
var ejGrid = exports.ejGrid = (_dec89 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'grid'), _dec90 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec91 = generateBindables('ejGrid', ['allowCellMerging', 'allowGrouping', 'allowKeyboardNavigation', 'allowFiltering', 'allowSorting', 'allowMultiSorting', 'allowPaging', 'allowReordering', 'allowResizeToFit', 'allowResizing', 'allowRowDragAndDrop', 'allowScrolling', 'allowSearching', 'allowSelection', 'allowTextWrap', 'allowMultipleExporting', 'commonWidth', 'gridLines', 'childGrid', 'columnLayout', 'columns', 'contextMenuSettings', 'cssClass', 'dataSource', 'detailsTemplate', 'editSettings', 'enableAltRow', 'enableAutoSaveOnSelectionChange', 'enableHeaderHover', 'enablePersistence', 'enableResponsiveRow', 'enableRowHover', 'enableRTL', 'enableTouch', 'enableToolbarItems', 'exportToExcelAction', 'exportToPdfAction', 'exportToWordAction', 'filterSettings', 'groupSettings', 'isResponsive', 'keySettings', 'locale', 'minWidth', 'pageSettings', 'query', 'resizeSettings', 'rowTemplate', 'rowDropSettings', 'searchSettings', 'selectedRecords', 'selectedRowIndex', 'selectedRowIndices', 'selectionSettings', 'selectionType', 'scrollSettings', 'showColumnChooser', 'showStackedHeader', 'showSummary', 'sortSettings', 'stackedHeaderRows', 'summaryRows', 'textWrapSettings', 'toolbarSettings'], ['dataSource', 'selectedRowIndices'], { 'enableRTL': 'enableRtl' }, ['dataSource']), _dec92 = (0, _aureliaDependencyInjection.inject)(Element, _aureliaTemplating.TemplatingEngine), _dec93 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'column'), _dec89(_class36 = _dec90(_class36 = _dec91(_class36 = _dec92(_class36 = (_class37 = function (_WidgetBase21) {
  ...
  function ejGrid(element, templateEngine) {
    ...
    _this25.templateProcessor = new TemplateProcessor(_this25, templateEngine);
    _this25.templateProcessor.initTemplate();
    return _this25;
  }
...
var ejKanban = exports.ejKanban = (_dec105 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'kanban'), _dec106 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec107 = generateBindables('ejKanban', ['allowDragAndDrop', 'allowExternalDragAndDrop', 'allowTitle', 'swimlaneSettings', 'allowToggleColumn', 'allowSearching', 'allowFiltering', 'allowSelection', 'allowHover', 'allowKeyboardNavigation', 'allowScrolling', 'allowPrinting', 'contextMenuSettings', 'columns', 'cardSettings', 'customToolbarItems', 'cssClass', 'dataSource', 'enableTouch', 'enableRTL', 'enableTotalCount', 'editSettings', 'fields', 'keyField', 'isResponsive', 'minWidth', 'filterSettings', 'query', 'keySettings', 'scrollSettings', 'searchSettings', 'selectionType', 'stackedHeaderRows', 'tooltipSettings', 'workflows', 'locale', 'showColumnWhenEmpty'], ['dataSource'], { 'enableRTL': 'enableRtl' }, ['dataSource']), _dec108 = (0, _aureliaDependencyInjection.inject)(Element), _dec109 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'kanban-column'), _dec105(_class42 = _dec106(_class42 = _dec107(_class42 = _dec108(_class42 = (_class43 = function (_WidgetBase25) {
  ...
  function ejKanban(element) {
    ...
    _initDefineProp(_this29, 'columns', _descriptor6, _this29);

    _this29.element = element;
    _this29.hasChildProperty = true;
    _this29.childPropertyName = 'columns';
    return _this29;
  }
...
var ejLinearGauge = exports.ejLinearGauge = (_dec116 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'linear-gauge'), _dec117 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec118 = generateBindables('ejLinearGauge', ['animationSpeed', 'backgroundColor', 'borderColor', 'enableAnimation', 'enableMarkerPointerAnimation', 'exportSettings', 'isResponsive', 'enableGroupSeparator', 'enableResize', 'frame', 'height', 'labelColor', 'locale', 'maximum', 'minimum', 'orientation', 'outerCustomLabelPosition', 'pointerGradient1', 'pointerGradient2', 'readOnly', 'scales', 'theme', 'tickColor', 'tooltip', 'value', 'width'], ['value', 'minimum', 'maximum']), _dec119 = (0, _aureliaDependencyInjection.inject)(Element), _dec116(_class47 = _dec117(_class47 = _dec118(_class47 = _dec119(_class47 = function (_WidgetBase27) {
...
var ejMap = exports.ejMap = (_dec127 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'map'), _dec128 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec129 = generateBindables('ejMap', ['background', 'baseMapIndex', 'centerPosition', 'draggingOnSelection', 'enableAnimation', 'enableRTL', 'enableLayerChangeAnimation', 'enablePan', 'enableResize', 'isResponsive', 'zoomSettings', 'navigationControl', 'locale', 'layers'], ['baseMapIndex', 'enablePan', 'enableResize', 'enableAnimation', 'zoomSettings.level', 'zoomSettings.minValue', 'zoomSettings.maxValue', 'zoomSettings.factor', 'zoomSettings.enableZoom', 'zoomSettings.enableZoomOnSelection', 'navigationControl.enableNavigation', 'navigationControl.orientation', 'navigationControl.absolutePosition', 'navigationControl.dockPosition'], { 'enableRTL': 'enableRtl' }), _dec130 = (0, _aureliaDependencyInjection.inject)(Element), _dec131 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'layer'), _dec127(_class50 = _dec128(_class50 = _dec129(_class50 = _dec130(_class50 = (_class51 = function (_WidgetBase29) {
  ...
  function ejMap(element) {
    ...
    _initDefineProp(_this33, 'layers', _descriptor7, _this33);

    _this33.element = element;
    _this33.hasChildProperty = true;
    _this33.childPropertyName = 'layers';
    return _this33;
  }
...
var ejToolbar = exports.ejToolbar = (_dec298 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'toolbar'), _dec299 = generateBindables('ejToolbar', ['cssClass', 'dataSource', 'disabledItemIndices', 'enabled', 'enabledItemIndices', 'enableRTL', 'enableSeparator', 'fields', 'height', 'htmlAttributes', 'hide', 'isResponsive', 'Items', 'orientation', 'query', 'responsiveType', 'showRoundedCorner', 'width'], [], { 'enableRTL': 'enableRtl' }), _dec300 = (0, _aureliaDependencyInjection.inject)(Element), _dec298(_class110 = _dec299(_class110 = _dec300(_class110 = function (_WidgetBase70) {
...
var ejTreeGrid = exports.ejTreeGrid = (_dec301 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'tree-grid'), _dec302 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec303 = generateBindables('ejTreeGrid', ['allowColumnReordering', 'allowColumnResize', 'allowDragAndDrop', 'allowFiltering', 'allowKeyboardNavigation', 'allowMultiSorting', 'allowPaging', 'allowSearching', 'allowSelection', 'allowSorting', 'allowTextWrap', 'altRowTemplateID', 'cellTooltipTemplate', 'childMapping', 'collapsibleTotalSummary', 'columnDialogFields', 'columnResizeSettings', 'columns', 'commonWidth', 'contextMenuSettings', 'cssClass', 'dataSource', 'detailsTemplate', 'detailsRowHeight', 'dragTooltip', 'editSettings', 'enableAltRow', 'enableCollapseAll', 'enableLoadOnDemand', 'enableResize', 'enableVirtualization', 'expandStateMapping', 'filterSettings', 'headerTextOverflow', 'idMapping', 'isResponsive', 'locale', 'pageSettings', 'parentIdMapping', 'parseRowTemplate', 'query', 'rowHeight', 'rowTemplateID', 'searchSettings', 'selectedCellIndexes', 'selectedRowIndex', 'selectionSettings', 'showColumnChooser', 'showColumnOptions', 'showDetailsRow', 'showDetailsRowInfoColumn', 'showGridCellTooltip', 'showGridExpandCellTooltip', 'showStackedHeader', 'showSummaryRow', 'showTotalSummary', 'sizeSettings', 'sortSettings', 'stackedHeaderRows', 'summaryRows', 'toolbarSettings', 'totalSummaryHeight', 'treeColumnIndex'], ['dataSource', 'selectedRowIndex', 'selectedCellIndexes', 'pageSettings.currentPage'], { 'altRowTemplateID': 'altRowTemplateId', 'rowTemplateID': 'rowTemplateId' }, ['dataSource']), _dec304 = (0, _aureliaDependencyInjection.inject)(Element, _aureliaTemplating.TemplatingEngine), _dec305 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'tree-grid-column'), _dec301(_class111 = _dec302(_class111 = _dec303(_class111 = _dec304(_class111 = (_class112 = function (_WidgetBase71) {
  ...
  function ejTreeGrid(element, templateEngine) {
    ...
    _initDefineProp(_this75, 'columns', _descriptor14, _this75);

    _this75.element = element;
    _this75.hasChildProperty = true;
    _this75.childPropertyName = 'columns';
    _this75.templateProcessor = new TemplateProcessor(_this75, templateEngine);
    _this75.templateProcessor.initTemplate();
    return _this75;
  }
...
var ejTreeMap = exports.ejTreeMap = (_dec313 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'tree-map'), _dec314 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec315 = generateBindables('ejTreeMap', ['borderBrush', 'borderThickness', 'uniColorMapping', 'desaturationColorMapping', 'paletteColorMapping', 'colorValuePath', 'colorPath', 'dataSource', 'dockPosition', 'drillDownHeaderColor', 'drillDownSelectionColor', 'isHierarchicalDatasource', 'header', 'enableDrillDown', 'drillDownValue', 'drillDownLevel', 'isResponsive', 'enableResize', 'draggingOnSelection', 'draggingGroupOnSelection', 'groupColorMapping', 'legendSettings', 'highlightBorderBrush', 'highlightBorderThickness', 'highlightGroupBorderBrush', 'highlightGroupBorderThickness', 'highlightGroupOnSelection', 'highlightOnSelection', 'itemsLayoutMode', 'enableGroupSeparator', 'locale', 'leafItemSettings', 'rangeColorMapping', 'selectionMode', 'groupSelectionMode', 'showLegend', 'enableGradient', 'showTooltip', 'tooltipTemplate', 'treeMapItems', 'levels', 'weightValuePath'], ['dataSource', 'weightValuePath'], {}, ['dataSource']), _dec316 = (0, _aureliaDependencyInjection.inject)(Element), _dec317 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'level'), _dec313(_class118 = _dec314(_class118 = _dec315(_class118 = _dec316(_class118 = (_class119 = function (_WidgetBase72) {
  ...
  function ejTreeMap(element) {
    ...
    _initDefineProp(_this76, 'levels', _descriptor16, _this76);

    _this76.element = element;
    _this76.hasChildProperty = true;
    _this76.childPropertyName = 'levels';
    return _this76;
  }
