...
var ejHeatMapLegend = exports.ejHeatMapLegend = (_dec91 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'heat-map-legend'), _dec92 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec93 = generateBindables('ejHeatMapLegend', ['width', 'height', 'isResponsive', 'showLabel', 'colorMappingCollection', 'orientation', 'legendMode']), _dec94 = (0, _aureliaDependencyInjection.inject)(Element), _dec91(_class35 = _dec92(_class35 = _dec93(_class35 = _dec94(_class35 = function (_WidgetBase23) {
...
var ejHeatMap = exports.ejHeatMap = (_dec95 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'heat-map'), _dec96 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec97 = generateBindables('ejHeatMap', ['width', 'height', 'id', 'showTooltip', 'tooltipSettings', 'itemsSource', 'heatMapCell', 'isResponsive', 'enableVirtualization', 'defaultColumnStyle', 'legendCollection', 'itemsMapping', 'colorMappingCollection']), _dec98 = (0, _aureliaDependencyInjection.inject)(Element), _dec95(_class36 = _dec96(_class36 = _dec97(_class36 = _dec98(_class36 = function (_WidgetBase24) {
  _inherits(ejHeatMap, _WidgetBase24);
...
var Layer = exports.Layer = (_dec121 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec122 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'layer'), _dec123 = generateBindables('layers', ['bingMapType', 'bubbleSettings', 'dataSource', 'shapeDataPath', 'shapePropertyPath', 'enableMouseHover', 'enableSelection', 'key', 'labelSettings', 'geometryType', 'layerType', 'legendSettings', 'mapItemsTemplate', 'markers', 'markerTemplate', 'selectedMapShapes', 'selectionMode', 'shapeData', 'shapeSettings', 'showMapItems', 'showTooltip', 'tooltipTemplate', 'urlTemplate', 'subLayers']), _dec121(_class45 = _dec122(_class45 = _dec123(_class45 = function Layer() {
  _classCallCheck(this, Layer);
}) || _class45) || _class45) || _class45);
var ejMap = exports.ejMap = (_dec124 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'map'), _dec125 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec126 = generateBindables('ejMap', ['background', 'baseMapIndex', 'centerPosition', 'draggingOnSelection', 'enableAnimation', 'enableRTL', 'enableLayerChangeAnimation', 'enablePan', 'enableResize', 'isResponsive', 'zoomSettings', 'navigationControl', 'locale', 'layers'], ['baseMapIndex', 'enablePan', 'enableResize', 'enableAnimation', 'zoomSettings.level', 'zoomSettings.minValue', 'zoomSettings.maxValue', 'zoomSettings.factor', 'zoomSettings.enableZoom', 'zoomSettings.enableZoomOnSelection', 'navigationControl.enableNavigation', 'navigationControl.orientation', 'navigationControl.absolutePosition', 'navigationControl.dockPosition'], { 'enableRTL': 'enableRtl' }), _dec127 = (0, _aureliaDependencyInjection.inject)(Element), _dec128 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'layer'), _dec124(_class46 = _dec125(_class46 = _dec126(_class46 = _dec127(_class46 = (_class47 = function (_WidgetBase30) {
  _inherits(ejMap, _WidgetBase30);
  ...
  function ejMap(element) {
    ...
    _initDefineProp(_this30, 'layers', _descriptor6, _this30);
  ...
  return ejMap;
}(WidgetBase), (_descriptor6 = _applyDecoratedDescriptor(_class47.prototype, 'layers', [_dec128], {
  enumerable: true,
  initializer: function initializer() {
    return [];
  }
...
var ejPager = exports.ejPager = (_dec139 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'pager'), _dec140 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec141 = generateBindables('ejPager', ['customText', 'currentPage', 'cssClass', 'enabled', 'enableExternalMessage', 'enableQueryString', 'enableRTL', 'externalMessage', 'isResponsive', 'locale', 'pageCount', 'pageSize', 'pageSizeList', 'pageSizeMessage', 'template', 'totalPages', 'totalRecordsCount', 'showPageInfo'], [], { 'enableRTL': 'enableRtl' }), _dec142 = (0, _aureliaDependencyInjection.inject)(Element), _dec139(_class52 = _dec140(_class52 = _dec141(_class52 = _dec142(_class52 = function (_WidgetBase34) {
...
var ejOverview = exports.ejOverview = (_dec143 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'overview'), _dec144 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec145 = generateBindables('ejOverview', ['sourceID', 'height', 'width'], [], { 'sourceID': 'sourceId' }), _dec146 = (0, _aureliaDependencyInjection.inject)(Element), _dec143(_class53 = _dec144(_class53 = _dec145(_class53 = _dec146(_class53 = function (_WidgetBase35) {
...
var ejRangeNavigator = exports.ejRangeNavigator = (_dec190 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'range-navigator'), _dec191 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec192 = generateBindables('ejRangeNavigator', ['allowSnapping', 'allowNextValue', 'border', 'dataSource', 'series', 'seriesSettings', 'enableDeferredUpdate', 'enableScrollbar', 'enableAutoResizing', 'enableRTL', 'isResponsive', 'labelSettings', 'locale', 'navigatorStyleSettings', 'padding', 'rangePadding', 'rangeSettings', 'selectedData', 'selectedRangeSettings', 'scrollRangeSettings', 'sizeSettings', 'theme', 'tooltipSettings', 'valueAxisSettings', 'valueType', 'xName', 'yName'], [], { 'enableRTL': 'enableRtl' }), _dec193 = (0, _aureliaDependencyInjection.inject)(Element), _dec194 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'range-series'), _dec190(_class69 = _dec191(_class69 = _dec192(_class69 = _dec193(_class69 = (_class70 = function (_WidgetBase46) {
  ...
  function ejRangeNavigator(element) {
    ...
    _initDefineProp(_this46, 'series', _descriptor9, _this46);

    _this46.element = element;
    _this46.hasChildProperty = true;
    _this46.childPropertyName = 'series';
    return _this46;
  }

  return ejRangeNavigator;
}(WidgetBase), (_descriptor9 = _applyDecoratedDescriptor(_class70.prototype, 'series', [_dec194], {
  enumerable: true,
  initializer: function initializer() {
    return [];
  }
})), _class70)) || _class69) || _class69) || _class69) || _class69);
var RangeSeries = exports.RangeSeries = (_dec195 = (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), _dec196 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'range-series'), _dec197 = generateBindables('series', ['xName', 'yName', 'dataSource', 'type', 'enableAnimation', 'fill']), _dec195(_class72 = _dec196(_class72 = _dec197(_class72 = function RangeSeries() {
  _classCallCheck(this, RangeSeries);
}) || _class72) || _class72) || _class72);
var ejRadioButton = exports.ejRadioButton = (_dec198 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'radio-button'), _dec199 = generateBindables('ejRadioButton', ['checked', 'cssClass', 'enabled', 'enablePersistence', 'enableRTL', 'htmlAttributes', 'id', 'idPrefix', 'name', 'size', 'text', 'validationMessage', 'validationRules', 'value'], [], { 'enableRTL': 'enableRtl' }), _dec200 = (0, _aureliaDependencyInjection.inject)(Element), _dec198(_class73 = _dec199(_class73 = _dec200(_class73 = function (_WidgetBase47) {
  _inherits(ejRadioButton, _WidgetBase47);
